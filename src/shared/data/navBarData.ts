...
export const NavBarData = [
    ...
    },
    {
        ...
        links: [
            ...
            { title: 'Армянская кухня', link: 'armenian-cuisine' },
            { title: 'Греческая кухня', link: 'greek-cuisine' },
            { title: 'Грузинская кухня', link: 'georgian-cuisine' },
            { title: 'Итальянская кухня', link: 'italian-cuisine' },
            { title: 'Испанская кухня', link: 'spanish-cuisine' },
            { title: 'Китайская кухня', link: 'chinese-cuisine' },
            { title: 'Мексиканская кухня', link: 'mexican-cuisine' },
            { title: 'Паназиатская кухня', link: 'pan-asian-cuisine' },
            { title: 'Русская кухня', link: 'russian-cuisine' },
            { title: 'Турецкая кухня', link: 'turkish-cuisine' },
            { title: 'Французская кухня', link: 'french-cuisine' },
            { title: 'Шведская кухня', link: 'swedish-cuisine' },
            { title: 'Японская кухня', link: 'japanese-cuisine' },
            { title: 'Другая кухня', link: 'other-cuisine' },
        ],
    },
    {
        icon: SaucesIcon,
