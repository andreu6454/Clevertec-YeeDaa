import { Avatar, AvatarBadge, Flex, Icon, Input, useDisclosure } from '@chakra-ui/react';
import { ChangeEvent, useEffect, useState } from 'react';

import { UploadProfilePhotoModal } from '~/pages/ProfileSettingsPage/AuthorizationAndPersonalisation/AvatarInput/UploadProfilePhotoModal/UploadProfilePhotoModal';
...
export const AvatarInput = ({ avatar }: AvatarInputProps) => {
    ...
    const handleFileChange = (event: ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            const imageUrl = URL.createObjectURL(file); // Создаём временный URL
